...
local function detect_black_spot()
    for i=1,4 do
		if robot.motor_ground[i].value == 0 then -- se almeno uno dei sensori detect 0 (nero) allora ci troviamo sopra uno spot
